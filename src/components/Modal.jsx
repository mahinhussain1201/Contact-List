  ...
  return (
    <div className="fixed inset-0 z-20 flex items-center justify-center">
      ...
      <div className="relative z-30 w-full max-w-lg mx-auto">
        <div className="bg-white/80 backdrop-blur-md rounded-xl shadow-lg ring-1 ring-white/30">
          <div className="px-5 py-4 border-b border-white/20 flex items-center justify-between">
            <h3 className="text-lg font-semibold text-gray-800">{title}</h3>
            <button onClick={onClose} className="p-2 rounded-md hover:bg-white/40" aria-label="Close">
